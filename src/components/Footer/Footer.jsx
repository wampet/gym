    ...
    <>
      <div className="Footer-container" id="about">
        <section className="footer">
          <div className="box-container">
            ...
            <div className="box">
              ...
              ></link>
              <i className="fa">
                <a href="tel:+256 751 772772">+256 751 772772 </a>
              </i>
              <br></br>
              <i className="fa">
                <a href="mailto:wampet232@gmail.com">wampet232@gmail.com</a>
              </i>
            </div>
            <div className="box">
              <h3>Follow us</h3>
              ...
              <div className="hero1">
                ...
                <div className="home__social-icon">
                  ...
                  <a href="https://www.google.com/maps/">
                    <i className="fab fa-google">Google Maps</i>
                  </a>
                </div>
              </div>
            </div>
        ...
        <div className="credits">
          <p>© 2023 Wampet. All Rights Reserved.</p>
        </div>
      </div>
    </>
  );
